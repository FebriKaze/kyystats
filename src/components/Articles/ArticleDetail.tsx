                  ...
                  {isShareMenuOpen && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-800 p-3 z-50 overflow-hidden"
                      >
